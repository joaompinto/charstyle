...
def generate_service_status():
    ...
    return list(zip(services, statuses))
...
def display_header():
    ...
    print("\n" + styled(" System Dashboard ", Style.BOLD, width=80, 
                       align=Align.CENTER, fill_char="="))
    print(styled(f" Last Updated: {current_time} ", Style.ITALIC, 
                width=80, align=Align.RIGHT))
    print()
...
def display_system_stats(stats):
    ...
    print(styled(" System Statistics ", Style.BOLD, width=80, 
                align=Align.LEFT, fill_char="-"))
    print(tabled(
        headers,
        rows,
...
def display_service_status(services):
    ...
    print(styled(" Service Status ", Style.BOLD, width=80, 
                align=Align.LEFT, fill_char="-"))
    print(tabled(
        headers,
        rows,
...
def display_footer():
    ...
    print(styled(" Press Ctrl+C to exit ", Style.ITALIC, width=80, 
                align=Align.CENTER, fill_char="-"))
    print()
