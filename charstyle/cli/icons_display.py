...
from charstyle import BLUE, BOLD, CYAN, GREEN, MAGENTA, RED, YELLOW, colored
...
def get_category_styles(
    ...
    return {
        ...
        "Directional": [blue, blue, blue, blue, blue, blue, blue, blue, blue, blue, blue, blue, 
        ...
        "Box Drawing - Extended": [blue, blue, blue, blue, blue, blue, yellow, yellow, green, green, green, green],
        "Spinners - Braille": [magenta, magenta, magenta, magenta, magenta, magenta, magenta, magenta, magenta, magenta],
        "Spinners - Line": [cyan, cyan, cyan, cyan],
        "Spinners - Dot": [yellow, yellow, yellow, yellow, yellow, yellow, yellow, yellow],
        "Spinners - Clock": [cyan, cyan, cyan, cyan, cyan, cyan, cyan, cyan, cyan, cyan, cyan, cyan],
...
def get_icon_categories() -> Dict[str, List[str]]:
    ...
    return {
        ...
        "Directional": ["ARROW_RIGHT", "ARROW_LEFT", "ARROW_UP", "ARROW_DOWN", 
                 "SPIN_ARROW_1", "SPIN_ARROW_2", "SPIN_ARROW_3", "SPIN_ARROW_4",
                 "SPIN_ARROW_5", "SPIN_ARROW_6", "SPIN_ARROW_7", "SPIN_ARROW_8",
                 "SPIN_EMOJI_ARROW_1", "SPIN_EMOJI_ARROW_2", "SPIN_EMOJI_ARROW_3", "SPIN_EMOJI_ARROW_4",
                 "SPIN_EMOJI_ARROW_5", "SPIN_EMOJI_ARROW_6", "SPIN_EMOJI_ARROW_7", "SPIN_EMOJI_ARROW_8"],
        "Shapes": ["CIRCLE", "SQUARE", "TRIANGLE", "STAR"],
        "Weather": ["SUN", "CLOUD", "UMBRELLA", "SNOWFLAKE"],
        "Weather Cycle": ["WEATHER_SUN", "WEATHER_SUN_SMALL_CLOUD", "WEATHER_SUN_CLOUD", 
                  "WEATHER_CLOUD_SUN", "WEATHER_CLOUD", "WEATHER_RAIN", 
        ...
        "Box Drawing - Basic": ["H_LINE", "V_LINE", "TOP_LEFT", "TOP_RIGHT", "BOTTOM_LEFT", "BOTTOM_RIGHT"],
        "Box Drawing - Extended": ["H_LINE_HEAVY", "V_LINE_HEAVY", "TOP_LEFT_HEAVY", "TOP_RIGHT_HEAVY", "BOTTOM_LEFT_HEAVY", "BOTTOM_RIGHT_HEAVY", 
                            "BOX_CROSS", "BOX_CROSS_HEAVY", "T_RIGHT", "T_LEFT", "T_DOWN", "T_UP"],
        "Spinners - Braille": ["SPIN_BRAILLE_1", "SPIN_BRAILLE_2", "SPIN_BRAILLE_3", "SPIN_BRAILLE_4", "SPIN_BRAILLE_5", 
                       "SPIN_BRAILLE_6", "SPIN_BRAILLE_7", "SPIN_BRAILLE_8", "SPIN_BRAILLE_9", "SPIN_BRAILLE_10"],
        "Spinners - Line": ["SPIN_LINE_1", "SPIN_LINE_2", "SPIN_LINE_3", "SPIN_LINE_4"],
        "Spinners - Dot": ["SPIN_DOT_1", "SPIN_DOT_2", "SPIN_DOT_3", "SPIN_DOT_4", 
                   "SPIN_DOT_5", "SPIN_DOT_6", "SPIN_DOT_7", "SPIN_DOT_8"],
        "Spinners - Clock": ["SPIN_CLOCK_1", "SPIN_CLOCK_2", "SPIN_CLOCK_3", "SPIN_CLOCK_4", 
                     "SPIN_CLOCK_5", "SPIN_CLOCK_6", "SPIN_CLOCK_7", "SPIN_CLOCK_8",
                     "SPIN_CLOCK_9", "SPIN_CLOCK_10", "SPIN_CLOCK_11", "SPIN_CLOCK_12"],
